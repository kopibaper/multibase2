      ...
      <div className='flex items-start gap-3'>
        ...
        <div className='flex-1 min-w-0'>
          ...
          <div className='flex items-center gap-2'>
            <code className='block px-3 py-2 bg-muted rounded text-sm font-mono break-all flex-1'>{displayValue}</code>
    ...
    <div className='space-y-4'>
      ...
      <div className='bg-yellow-500/10 border border-yellow-500/30 rounded-lg p-4'>
        <div className='flex gap-3'>
          ...
          <div>
            <h3 className='text-sm font-medium text-yellow-500'>Sensitive Information</h3>
            <p className='mt-1 text-sm text-yellow-500/80'>
              These credentials provide access to your Supabase instance. Keep them secure and never share them
              publicly.
            </p>
          </div>
        </div>
          ...
          <div className='flex justify-between'>
            ...
            <span
              className={`px-2 py-1 rounded text-sm font-medium ${
                instance.status === 'running' ? 'bg-green-100 text-green-700' : 'bg-gray-100 text-gray-700'
              }`}
            >
              {instance.status}
            </span>
