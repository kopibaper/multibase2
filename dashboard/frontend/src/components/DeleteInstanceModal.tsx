...
export default function DeleteInstanceModal({ instance, open, onClose, onConfirm }: DeleteInstanceModalProps) {
            ...
            <div className='flex gap-3'>
              ...
              <div>
                ...
                <p className='mt-1 text-sm text-destructive/90'>
                  This action cannot be undone. The instance <strong>{instance.name}</strong> will be permanently
                  deleted.
                </p>
              </div>
            </div>
          ...
          <div className='flex items-start gap-3 p-3 bg-muted/50 rounded-md'>
            ...
            <div className='flex-1'>
              ...
              <p className='mt-1 text-xs text-muted-foreground'>
                If enabled, all data (database, storage, etc.) will be permanently deleted. Otherwise, the volumes will
                be preserved.
              </p>
            </div>
          </div>
