...
import { Book, Code, Layers, FileText, Cloud, Network, Building2, Menu, X, Package, Terminal, Bot } from 'lucide-react';
  ...
  const sidebarContent = (onClick?: () => void) => (
    <>
      ...
      <SidebarGroup title='AI Assistant'>
        <SidebarLink to='/setup/ai-assistant/overview' icon={Bot} onClick={onClick}>Overview & Setup</SidebarLink>
        <SidebarLink to='/setup/ai-assistant/tools-instances' icon={Bot} onClick={onClick}>Instance Tools</SidebarLink>
        <SidebarLink to='/setup/ai-assistant/tools-database' icon={Bot} onClick={onClick}>Database & RLS Tools</SidebarLink>
        <SidebarLink to='/setup/ai-assistant/tools-storage' icon={Bot} onClick={onClick}>Storage & Auth Tools</SidebarLink>
        <SidebarLink to='/setup/ai-assistant/tools-functions' icon={Bot} onClick={onClick}>Edge Function Tools</SidebarLink>
        <SidebarLink to='/setup/ai-assistant/tools-monitoring' icon={Bot} onClick={onClick}>Monitoring Tools</SidebarLink>
      </SidebarGroup>
